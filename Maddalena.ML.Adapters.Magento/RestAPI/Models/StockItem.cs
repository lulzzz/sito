...
namespace Magento.RestApi.Models
{
    ...
    public class StockItem : ChangeTracking<StockItem>
    {
        ...
        /// <summary>
        /// The customer can place the order for products that are out of stock at the moment (0 - No Backorders, 1 - Allow Qty Below 0, and 2 - Allow Qty Below 0 and Notify Person)
        /// </summary>
