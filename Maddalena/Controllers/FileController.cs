...
namespace Maddalena.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        public async Task<IActionResult> Upload()
        {
            ...
            foreach (var x in files) list.Add(await UploadFile.Create(x, User));
        ...
        public async Task<IActionResult> Download(string id)
        {
            ...
            return File(GridFS.Bucket.OpenDownloadStreamByName(file.GridName), file.ContentType, file.FileName,
                file.DateTime, new EntityTagHeaderValue($"\"{file.GetHashCode()}\""));
        }

        [AllowAnonymous]
        public IActionResult Dropbox()
        {
            return View();
        }
