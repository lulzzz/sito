...
namespace Maddalena.Markdig.Parsers
{
    ...
    public struct ListInfo
    {
        ...
        /// <param name="defaultOrderedStart">
        ///     The default string used as a starting sequence for the ordered list (e.g: '1' for an
        ...
        /// <summary>
        ///     Gets or sets default string used as a starting sequence for the ordered list (e.g: '1' for an numbered ordered
        ///     list)
        /// </summary>
