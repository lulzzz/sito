...
namespace Maddalena.Markdig.Parsers
{
    ...
    public interface IPostInlineProcessor
    {
        ...
        /// <returns>
        ///     <c>true</c> to continue to the next delimiter processor;
        ///     <c>false</c> to stop the process (in case a processor is perfoming sub-sequent processor itself)
        /// </returns>
        bool PostProcess(InlineProcessor state, Inline root, Inline lastChild, int postInlineProcessorIndex,
