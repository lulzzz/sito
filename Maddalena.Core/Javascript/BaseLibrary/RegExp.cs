...
namespace NiL.JS.BaseLibrary
{
    ...
    public sealed class RegExp : CustomType
    {
        ...
        private static readonly RegExpCacheItem[] _cache = new RegExpCacheItem[_cacheSize];
        ...
        [DoNotEnumerate]
        [NotConfigurable]
        public Boolean ignoreCase => (_regex.Options & RegexOptions.IgnoreCase) != 0;
        ...
        [DoNotEnumerate]
        [NotConfigurable]
        public Boolean multiline => (_regex.Options & RegexOptions.Multiline) != 0;
        ...
        [DoNotEnumerate]
        [NotConfigurable]
        public String source => new String(_source);
