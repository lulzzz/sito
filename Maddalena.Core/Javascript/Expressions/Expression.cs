...
namespace Maddalena.Core.Javascript.Expressions
{
    ...
    public abstract class Expression : CodeNode
    {
        ...
        protected internal virtual bool ContextIndependent => (_left == null || _left.ContextIndependent)
                                                              && (_right == null || _right.ContextIndependent);

        protected internal virtual bool NeedDecompose => (_left != null && _left.NeedDecompose)
