        ...
        private static readonly List<MatchExpression<ClientOs>> Matchs = new List<MatchExpression<ClientOs>>
        {
            ...
            new MatchExpression<ClientOs>
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(windows\sphone(?:\sos)*)[\s\/]?([\d\.\s]+\w)*",
                        RegexOptions.IgnoreCase) // Windows Phone
                },
                Action = (match, current) =>
                {
                    current.Name = new Regex(@"(^[a-zA-Z]+\s[a-zA-Z]+)", RegexOptions.IgnoreCase).Match(match.Value)
                        .Value;
            ...
            new MatchExpression<ClientOs>
            {
                ...
                Action = (match, current) =>
                {
                    ...
                    {
                        match.Value.Substring(0, match.Value.IndexOf(" ", StringComparison.Ordinal)),
            ...
            new MatchExpression<ClientOs>
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(android|webos|palm\sos|qnx|bada|rim\stablet\sos|meego|contiki)[\/\s-]?([\w\.]+)*",
            ...
            new MatchExpression<ClientOs>
            {
                ...
                {
                    // Console
                    new Regex(@"(nintendo|playstation)\s([wids34portablevu]+)",
                        RegexOptions.IgnoreCase), // Nintendo/Playstation
            ...
            new MatchExpression<ClientOs>
            {
                Regexes = new List<Regex>
                {
                    new Regex(@"\s([frentopc-]{0,4}bsd|dragonfly)\s?([\w\.]+)*",
            ...
            new MatchExpression<ClientOs>
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(plan\s9|minix|beos|os\/2|amigaos|morphos|risc\sos|openvms)",
