        ...
        private static readonly List<MatchExpression> _matchs = new List<MatchExpression>
        {
            new MatchExpression
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(opera\s[mobiletab]+).+version\/([\w\.-]+)",
                        RegexOptions.IgnoreCase), // Opera Mobi/Tablet
            ...
            new MatchExpression
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(lunascape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]+)*",
                        RegexOptions.IgnoreCase), // Lunascape/Maxthon/Netfront/Jasmine/Blazer

                    new Regex(@"(avant\s|iemobile|slim|baidu)(?:browser)?[\/\s]?([\w\.]*)",
            ...
            new MatchExpression
            {
                Regexes = new List<Regex>
                {
                    new Regex(@"(chrome|omniweb|arora|[tizenoka]{5}\s?browser)\/v?([\w\.]+)",
            ...
            new MatchExpression
            {
                Regexes = new List<Regex>
                {
                    ...
                    new Regex(@"(firefox|seamonkey|k-meleon|icecat|iceape|firebird|phoenix)\/([\w\.-]+)",
                    ...
                    new Regex(@"(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir)[\/\s]?([\w\.]+)",
