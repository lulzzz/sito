...
namespace Maddalena
{
    ...
    public class Country
    {
        ...
        public static Country World => new Country
        {
            CommonName = "World",
            OfficialName = "World",
            TLD = new[] {".com"},
        ...
        public static Country Aruba => new Country
        {
            CommonName = "Aruba",
            OfficialName = "Aruba",
            TLD = new[] {".aw"},
        ...
        public static Country Afghanistan => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.IRN, CountryCodeISO3.PAK, CountryCodeISO3.TKM, CountryCodeISO3.UZB, CountryCodeISO3.TJK,
                CountryCodeISO3.CHN
            },
            Landlocked = true,
            Area = 652230
        ...
        public static Country Angola => new Country
        {
            CommonName = "Angola",
            ...
            Borders = new[] {CountryCodeISO3.COG, CountryCodeISO3.COD, CountryCodeISO3.ZMB, CountryCodeISO3.NAM},
            Landlocked = false,
            Area = 1246700
        };

        public static Country Anguilla => new Country
        {
            CommonName = "Anguilla",
        ...
        public static Country ÅlandIslands => new Country
        {
        ...
        public static Country Albania => new Country
        {
            CommonName = "Albania",
            ...
            Borders = new[] {CountryCodeISO3.MNE, CountryCodeISO3.GRC, CountryCodeISO3.MKD, CountryCodeISO3.KOS},
            Landlocked = false,
            Area = 28748
        };

        public static Country Andorra => new Country
        {
            CommonName = "Andorra",
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.FRA, CountryCodeISO3.ESP},
            Landlocked = true,
            Area = 468
        };

        public static Country UnitedArabEmirates => new Country
        {
            ...
            Borders = new[] {CountryCodeISO3.OMN, CountryCodeISO3.SAU},
            Landlocked = false,
            Area = 83600
        };
        ...
        public static Country Argentina => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BOL, CountryCodeISO3.BRA, CountryCodeISO3.CHL, CountryCodeISO3.PRY, CountryCodeISO3.URY
            },
            Landlocked = false,
            Area = 2780400
        };

        public static Country Armenia => new Country
        {
            CommonName = "Armenia",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.AZE, CountryCodeISO3.GEO, CountryCodeISO3.IRN, CountryCodeISO3.TUR},
            Landlocked = true,
            Area = 29743
        };

        public static Country AmericanSamoa => new Country
        {
        ...
        public static Country Antarctica => new Country
        {
        ...
        public static Country FrenchSouthernandAntarcticLands => new Country
        {
        ...
        public static Country AntiguaandBarbuda => new Country
        {
        ...
        public static Country Austria => new Country
        {
            CommonName = "Austria",
            ...
            Borders = new[]
            {
                CountryCodeISO3.CZE, CountryCodeISO3.DEU, CountryCodeISO3.HUN, CountryCodeISO3.ITA, CountryCodeISO3.LIE,
                CountryCodeISO3.SVK, CountryCodeISO3.SVN, CountryCodeISO3.CHE
            },
            Landlocked = true,
            Area = 83871
        };

        public static Country Azerbaijan => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.ARM, CountryCodeISO3.GEO, CountryCodeISO3.IRN, CountryCodeISO3.RUS, CountryCodeISO3.TUR
            },
            Landlocked = true,
            Area = 86600
        };

        public static Country Burundi => new Country
        {
            CommonName = "Burundi",
            ...
            Borders = new[] {CountryCodeISO3.COD, CountryCodeISO3.RWA, CountryCodeISO3.TZA},
            Landlocked = true,
            Area = 27834
        };
        ...
        public static Country Belgium => new Country
        {
            ...
            {
                "BE", "België", "Belgie", "Belgien", "Belgique", "Kingdom of Belgium", "Koninkrijk België",
                "Royaume de Belgique", "Königreich Belgien"
            },
            Region = "Europe",
            SubRegion = "Western Europe",
            Borders = new[] {CountryCodeISO3.FRA, CountryCodeISO3.DEU, CountryCodeISO3.LUX, CountryCodeISO3.NLD},
            Landlocked = false,
            Area = 30528
        };

        public static Country Benin => new Country
        {
            CommonName = "Benin",
            ...
            Borders = new[] {CountryCodeISO3.BFA, CountryCodeISO3.NER, CountryCodeISO3.NGA, CountryCodeISO3.TGO},
            Landlocked = false,
            Area = 112622
        };

        public static Country BurkinaFaso => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BEN, CountryCodeISO3.CIV, CountryCodeISO3.GHA, CountryCodeISO3.MLI, CountryCodeISO3.NER,
                CountryCodeISO3.TGO
            },
            Landlocked = true,
            Area = 272967
        ...
        public static Country Bangladesh => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Southern Asia",
            Borders = new[] {CountryCodeISO3.MMR, CountryCodeISO3.IND},
            Landlocked = false,
            Area = 147570
        };

        public static Country Bulgaria => new Country
        {
            CommonName = "Bulgaria",
            ...
            Borders = new[]
            {
                CountryCodeISO3.GRC, CountryCodeISO3.MKD, CountryCodeISO3.ROU, CountryCodeISO3.SRB, CountryCodeISO3.TUR
            },
            Landlocked = false,
            Area = 110879
        };

        public static Country Bahrain => new Country
        {
            CommonName = "Bahrain",
        ...
        public static Country Bahamas => new Country
        {
            CommonName = "Bahamas",
        ...
        public static Country BosniaandHerzegovina => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.HRV, CountryCodeISO3.MNE, CountryCodeISO3.SRB},
            Landlocked = false,
            Area = 51209
        };

        public static Country SaintBarthélemy => new Country
        {
        ...
        public static Country Belarus => new Country
        {
            CommonName = "Belarus",
            ...
            AlternativeSpellings = new[]
            {
                "BY", "Bielaruś", "Republic of Belarus", "Белоруссия", "Республика Беларусь", "Belorussiya",
                "Respublika Belarus’"
            },
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[]
            {
                CountryCodeISO3.LVA, CountryCodeISO3.LTU, CountryCodeISO3.POL, CountryCodeISO3.RUS, CountryCodeISO3.UKR
            },
            Landlocked = true,
            Area = 207600
        };

        public static Country Belize => new Country
        {
            CommonName = "Belize",
            OfficialName = "Belize",
            TLD = new[] {".bz"},
            ...
            Borders = new[] {CountryCodeISO3.GTM, CountryCodeISO3.MEX},
            Landlocked = false,
            Area = 22966
        };

        public static Country Bermuda => new Country
        {
            CommonName = "Bermuda",
        ...
        public static Country Bolivia => new Country
        {
            CommonName = "Bolivia",
            ...
            AlternativeSpellings = new[]
            {
                "BO", "Buliwya", "Wuliwya", "Bolivia, Plurinational State of", "Plurinational State of Bolivia",
                "Estado Plurinacional de Bolivia", "Buliwya Mamallaqta", "Wuliwya Suyu", "Tetã Volívia"
            },
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[]
            {
                CountryCodeISO3.ARG, CountryCodeISO3.BRA, CountryCodeISO3.CHL, CountryCodeISO3.PRY, CountryCodeISO3.PER
            },
            Landlocked = true,
            Area = 1098581
        };
        ...
        public static Country Brazil => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.ARG, CountryCodeISO3.BOL, CountryCodeISO3.COL, CountryCodeISO3.GUF, CountryCodeISO3.GUY,
                CountryCodeISO3.PRY, CountryCodeISO3.PER, CountryCodeISO3.SUR, CountryCodeISO3.URY, CountryCodeISO3.VEN
            },
            Landlocked = false,
            Area = 8515767
        };

        public static Country Barbados => new Country
        {
            CommonName = "Barbados",
        ...
        public static Country Brunei => new Country
        {
            CommonName = "Brunei",
            ...
            Borders = new[] {CountryCodeISO3.MYS},
            Landlocked = false,
            Area = 5765
        };

        public static Country Bhutan => new Country
        {
            CommonName = "Bhutan",
            ...
            Region = "Asia",
            SubRegion = "Southern Asia",
            Borders = new[] {CountryCodeISO3.CHN, CountryCodeISO3.IND},
            Landlocked = true,
            Area = 38394
        };

        public static Country BouvetIsland => new Country
        {
        ...
        public static Country Botswana => new Country
        {
            CommonName = "Botswana",
            ...
            Borders = new[] {CountryCodeISO3.NAM, CountryCodeISO3.ZAF, CountryCodeISO3.ZMB, CountryCodeISO3.ZWE},
            Landlocked = true,
            Area = 582000
        };

        public static Country CentralAfricanRepublic => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.CMR, CountryCodeISO3.TCD, CountryCodeISO3.COD, CountryCodeISO3.COG, CountryCodeISO3.SSD,
                CountryCodeISO3.SDN
            },
            Landlocked = true,
            Area = 622984
        ...
        public static Country Canada => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Northern America",
            Borders = new[] {CountryCodeISO3.USA},
            Landlocked = false,
            Area = 9984670
        };

        public static Country CocosKeelingIslands => new Country
        {
        ...
        public static Country Switzerland => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AUT, CountryCodeISO3.FRA, CountryCodeISO3.ITA, CountryCodeISO3.LIE, CountryCodeISO3.DEU
            },
            Landlocked = true,
            Area = 41284
        };

        public static Country Chile => new Country
        {
            CommonName = "Chile",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.ARG, CountryCodeISO3.BOL, CountryCodeISO3.PER},
            Landlocked = false,
            Area = 756102
        };
        ...
        public static Country China => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "CN", "Zhōngguó", "Zhongguo", "Zhonghua", "People's Republic of China", "中华人民共和国",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AFG, CountryCodeISO3.BTN, CountryCodeISO3.MMR, CountryCodeISO3.HKG, CountryCodeISO3.IND,
                CountryCodeISO3.KAZ, CountryCodeISO3.PRK, CountryCodeISO3.KGZ, CountryCodeISO3.LAO, CountryCodeISO3.MAC,
                CountryCodeISO3.MNG, CountryCodeISO3.PAK, CountryCodeISO3.RUS, CountryCodeISO3.TJK, CountryCodeISO3.VNM
            },
            Landlocked = false,
            Area = 9706961
        };

        public static Country IvoryCoast => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BFA, CountryCodeISO3.GHA, CountryCodeISO3.GIN, CountryCodeISO3.LBR, CountryCodeISO3.MLI
            },
            Landlocked = false,
            Area = 322463
        };

        public static Country Cameroon => new Country
        {
            CommonName = "Cameroon",
            ...
            Borders = new[]
            {
                CountryCodeISO3.CAF, CountryCodeISO3.TCD, CountryCodeISO3.COG, CountryCodeISO3.GNQ, CountryCodeISO3.GAB,
                CountryCodeISO3.NGA
            },
            Landlocked = false,
            Area = 475442
        ...
        public static Country DRCongo => new Country
        {
            CommonName = "DR Congo",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AGO, CountryCodeISO3.BDI, CountryCodeISO3.CAF, CountryCodeISO3.COG, CountryCodeISO3.RWA,
                CountryCodeISO3.SSD, CountryCodeISO3.TZA, CountryCodeISO3.UGA, CountryCodeISO3.ZMB
            },
            Landlocked = false,
            Area = 2344858
        };

        public static Country RepublicoftheCongo => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AGO, CountryCodeISO3.CMR, CountryCodeISO3.CAF, CountryCodeISO3.COD, CountryCodeISO3.GAB
            },
            Landlocked = false,
            Area = 342000
        };

        public static Country CookIslands => new Country
        {
        ...
        public static Country Colombia => new Country
        {
            CommonName = "Colombia",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BRA, CountryCodeISO3.ECU, CountryCodeISO3.PAN, CountryCodeISO3.PER, CountryCodeISO3.VEN
            },
            Landlocked = false,
            Area = 1141748
        };

        public static Country Comoros => new Country
        {
            CommonName = "Comoros",
        ...
        public static Country CapeVerde => new Country
        {
        ...
        public static Country CostaRica => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.NIC, CountryCodeISO3.PAN},
            Landlocked = false,
            Area = 51100
        };

        public static Country Cuba => new Country
        {
            CommonName = "Cuba",
        ...
        public static Country Curaçao => new Country
        {
            CommonName = "Curaçao",
        ...
        public static Country ChristmasIsland => new Country
        {
        ...
        public static Country CaymanIslands => new Country
        {
        ...
        public static Country Cyprus => new Country
        {
            CommonName = "Cyprus",
            ...
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[] {CountryCodeISO3.GBR},
            Landlocked = false,
            Area = 9251
        };

        public static Country CzechRepublic => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[] {CountryCodeISO3.AUT, CountryCodeISO3.DEU, CountryCodeISO3.POL, CountryCodeISO3.SVK},
            Landlocked = true,
            Area = 78865
        };
        ...
        public static Country Germany => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AUT, CountryCodeISO3.BEL, CountryCodeISO3.CZE, CountryCodeISO3.DNK, CountryCodeISO3.FRA,
                CountryCodeISO3.LUX, CountryCodeISO3.NLD, CountryCodeISO3.POL, CountryCodeISO3.CHE
            },
            Landlocked = false,
            Area = 357114
        };

        public static Country Djibouti => new Country
        {
            CommonName = "Djibouti",
            ...
            AlternativeSpellings = new[]
            {
                "DJ", "Jabuuti", "Gabuuti", "Republic of Djibouti", "République de Djibouti", "Gabuutih Ummuuno",
                "Jamhuuriyadda Jabuuti"
            },
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.ERI, CountryCodeISO3.ETH, CountryCodeISO3.SOM},
            Landlocked = false,
            Area = 23200
        };

        public static Country Dominica => new Country
        {
            CommonName = "Dominica",
        ...
        public static Country Denmark => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.DEU},
            Landlocked = false,
            Area = 43094
        };

        public static Country DominicanRepublic => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Caribbean",
            Borders = new[] {CountryCodeISO3.HTI},
            Landlocked = false,
            Area = 48671
        };

        public static Country Algeria => new Country
        {
            CommonName = "Algeria",
            ...
            Borders = new[]
            {
                CountryCodeISO3.TUN, CountryCodeISO3.LBY, CountryCodeISO3.NER, CountryCodeISO3.ESH, CountryCodeISO3.MRT,
                CountryCodeISO3.MLI, CountryCodeISO3.MAR
            },
            Landlocked = false,
            Area = 2381741
        };

        public static Country Ecuador => new Country
        {
            CommonName = "Ecuador",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.COL, CountryCodeISO3.PER},
            Landlocked = false,
            Area = 276841
        };

        public static Country Egypt => new Country
        {
            CommonName = "Egypt",
            ...
            Region = "Africa",
            SubRegion = "Northern Africa",
            Borders = new[] {CountryCodeISO3.ISR, CountryCodeISO3.LBY, CountryCodeISO3.SDN},
            Landlocked = false,
            Area = 1002450
        };

        public static Country Eritrea => new Country
        {
            CommonName = "Eritrea",
            ...
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.DJI, CountryCodeISO3.ETH, CountryCodeISO3.SDN},
            Landlocked = false,
            Area = 117600
        };

        public static Country WesternSahara => new Country
        {
            ...
            Region = "Africa",
            SubRegion = "Northern Africa",
            Borders = new[] {CountryCodeISO3.DZA, CountryCodeISO3.MRT, CountryCodeISO3.MAR},
            Landlocked = false,
            Area = 266000
        };

        public static Country Spain => new Country
        {
            CommonName = "Spain",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AND, CountryCodeISO3.FRA, CountryCodeISO3.GIB, CountryCodeISO3.PRT, CountryCodeISO3.MAR
            },
            Landlocked = false,
            Area = 505992
        };

        public static Country Estonia => new Country
        {
            CommonName = "Estonia",
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.LVA, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 45227
        };

        public static Country Ethiopia => new Country
        {
            CommonName = "Ethiopia",
            ...
            Borders = new[]
            {
                CountryCodeISO3.DJI, CountryCodeISO3.ERI, CountryCodeISO3.KEN, CountryCodeISO3.SOM, CountryCodeISO3.SSD,
                CountryCodeISO3.SDN
            },
            Landlocked = true,
            Area = 1104300
        ...
        public static Country Finland => new Country
        {
            CommonName = "Finland",
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.NOR, CountryCodeISO3.SWE, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 338424
        };

        public static Country Fiji => new Country
        {
            CommonName = "Fiji",
        ...
        public static Country FalklandIslands => new Country
        {
        ...
        public static Country France => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AND, CountryCodeISO3.BEL, CountryCodeISO3.DEU, CountryCodeISO3.ITA, CountryCodeISO3.LUX,
                CountryCodeISO3.MCO, CountryCodeISO3.ESP, CountryCodeISO3.CHE
            },
            Landlocked = false,
            Area = 551695
        };

        public static Country FaroeIslands => new Country
        {
        ...
        public static Country Micronesia => new Country
        {
        ...
        public static Country Gabon => new Country
        {
            CommonName = "Gabon",
            ...
            Region = "Africa",
            SubRegion = "Middle Africa",
            Borders = new[] {CountryCodeISO3.CMR, CountryCodeISO3.COG, CountryCodeISO3.GNQ},
            Landlocked = false,
            Area = 267668
        };

        public static Country UnitedKingdom => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.IRL},
            Landlocked = false,
            Area = 242900
        };

        public static Country Georgia => new Country
        {
            CommonName = "Georgia",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.ARM, CountryCodeISO3.AZE, CountryCodeISO3.RUS, CountryCodeISO3.TUR},
            Landlocked = false,
            Area = 69700
        };

        public static Country Guernsey => new Country
        {
            CommonName = "Guernsey",
        ...
        public static Country Ghana => new Country
        {
            CommonName = "Ghana",
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.BFA, CountryCodeISO3.CIV, CountryCodeISO3.TGO},
            Landlocked = false,
            Area = 238533
        };

        public static Country Gibraltar => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.ESP},
            Landlocked = false,
            Area = 6
        };

        public static Country Guinea => new Country
        {
            CommonName = "Guinea",
            ...
            Borders = new[]
            {
                CountryCodeISO3.CIV, CountryCodeISO3.GNB, CountryCodeISO3.LBR, CountryCodeISO3.MLI, CountryCodeISO3.SEN,
                CountryCodeISO3.SLE
            },
            Landlocked = false,
            Area = 245857
        ...
        public static Country Guadeloupe => new Country
        {
        ...
        public static Country Gambia => new Country
        {
            CommonName = "Gambia",
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.SEN},
            Landlocked = false,
            Area = 10689
        };

        public static Country GuineaBissau => new Country
        {
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.GIN, CountryCodeISO3.SEN},
            Landlocked = false,
            Area = 36125
        };

        public static Country EquatorialGuinea => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "GQ", "Republic of Equatorial Guinea", "República de Guinea Ecuatorial",
                "République de Guinée équatoriale", "República da Guiné Equatorial"
            },
            Region = "Africa",
            SubRegion = "Middle Africa",
            Borders = new[] {CountryCodeISO3.CMR, CountryCodeISO3.GAB},
            Landlocked = false,
            Area = 28051
        };

        public static Country Greece => new Country
        {
            CommonName = "Greece",
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.ALB, CountryCodeISO3.BGR, CountryCodeISO3.TUR, CountryCodeISO3.MKD},
            Landlocked = false,
            Area = 131990
        };

        public static Country Grenada => new Country
        {
            CommonName = "Grenada",
        ...
        public static Country Greenland => new Country
        {
        ...
        public static Country Guatemala => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.BLZ, CountryCodeISO3.SLV, CountryCodeISO3.HND, CountryCodeISO3.MEX},
            Landlocked = false,
            Area = 108889
        };

        public static Country FrenchGuiana => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.BRA, CountryCodeISO3.SUR},
            Landlocked = false,
            Area = 83534
        };

        public static Country Guam => new Country
        {
            CommonName = "Guam",
            OfficialName = "Guam",
            TLD = new[] {".gu"},
        ...
        public static Country Guyana => new Country
        {
            CommonName = "Guyana",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.BRA, CountryCodeISO3.SUR, CountryCodeISO3.VEN},
            Landlocked = false,
            Area = 214969
        };

        public static Country HongKong => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Eastern Asia",
            Borders = new[] {CountryCodeISO3.CHN},
            Landlocked = false,
            Area = 1104
        };

        public static Country HeardIslandandMcDonaldIslands => new Country
        {
        ...
        public static Country Honduras => new Country
        {
            CommonName = "Honduras",
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.GTM, CountryCodeISO3.SLV, CountryCodeISO3.NIC},
            Landlocked = false,
            Area = 112492
        };

        public static Country Croatia => new Country
        {
            CommonName = "Croatia",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BIH, CountryCodeISO3.HUN, CountryCodeISO3.MNE, CountryCodeISO3.SRB, CountryCodeISO3.SVN
            },
            Landlocked = false,
            Area = 56594
        };

        public static Country Haiti => new Country
        {
            CommonName = "Haiti",
            ...
            Region = "Americas",
            SubRegion = "Caribbean",
            Borders = new[] {CountryCodeISO3.DOM},
            Landlocked = false,
            Area = 27750
        };

        public static Country Hungary => new Country
        {
            CommonName = "Hungary",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AUT, CountryCodeISO3.HRV, CountryCodeISO3.ROU, CountryCodeISO3.SRB, CountryCodeISO3.SVK,
                CountryCodeISO3.SVN, CountryCodeISO3.UKR
            },
            Landlocked = true,
            Area = 93028
        };
        ...
        public static Country Indonesia => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.TLS, CountryCodeISO3.MYS, CountryCodeISO3.PNG},
            Landlocked = false,
            Area = 1904569
        };

        public static Country IsleofMan => new Country
        {
        ...
        public static Country India => new Country
        {
            CommonName = "India",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AFG, CountryCodeISO3.BGD, CountryCodeISO3.BTN, CountryCodeISO3.MMR, CountryCodeISO3.CHN,
                CountryCodeISO3.NPL, CountryCodeISO3.PAK, CountryCodeISO3.LKA
            },
            Landlocked = false,
            Area = 3287590
        };

        public static Country BritishIndianOceanTerritory => new Country
        {
        ...
        public static Country Iran => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AFG, CountryCodeISO3.ARM, CountryCodeISO3.AZE, CountryCodeISO3.IRQ, CountryCodeISO3.PAK,
                CountryCodeISO3.TUR, CountryCodeISO3.TKM
            },
            Landlocked = false,
            Area = 1648195
        };

        public static Country Iraq => new Country
        {
            CommonName = "Iraq",
            ...
            Borders = new[]
            {
                CountryCodeISO3.IRN, CountryCodeISO3.JOR, CountryCodeISO3.KWT, CountryCodeISO3.SAU, CountryCodeISO3.SYR,
                CountryCodeISO3.TUR
            },
            Landlocked = false,
            Area = 438317
        ...
        public static Country Iceland => new Country
        {
            CommonName = "Iceland",
        ...
        public static Country Israel => new Country
        {
            CommonName = "Israel",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.EGY, CountryCodeISO3.JOR, CountryCodeISO3.LBN, CountryCodeISO3.SYR},
            Landlocked = false,
            Area = 20770
        };

        public static Country Italy => new Country
        {
            CommonName = "Italy",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AUT, CountryCodeISO3.FRA, CountryCodeISO3.SMR, CountryCodeISO3.SVN, CountryCodeISO3.CHE,
                CountryCodeISO3.VAT
            },
            Landlocked = false,
            Area = 301336
        ...
        public static Country Jamaica => new Country
        {
            CommonName = "Jamaica",
        ...
        public static Country Jersey => new Country
        {
            CommonName = "Jersey",
        ...
        public static Country Jordan => new Country
        {
            CommonName = "Jordan",
            ...
            AlternativeSpellings =
                new[] {"JO", "Hashemite Kingdom of Jordan", "al-Mamlakah al-Urdunīyah al-Hāshimīyah"},
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.IRQ, CountryCodeISO3.ISR, CountryCodeISO3.SAU, CountryCodeISO3.SYR},
            Landlocked = false,
            Area = 89342
        };
        ...
        public static Country Kazakhstan => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "KZ", "Qazaqstan", "Казахстан", "Republic of Kazakhstan", "Қазақстан Республикасы",
                "Qazaqstan Respublïkası", "Республика Казахстан", "Respublika Kazakhstan"
            },
            Region = "Asia",
            SubRegion = "Central Asia",
            Borders = new[]
            {
                CountryCodeISO3.CHN, CountryCodeISO3.KGZ, CountryCodeISO3.RUS, CountryCodeISO3.TKM, CountryCodeISO3.UZB
            },
            Landlocked = true,
            Area = 2724900
        };

        public static Country Kenya => new Country
        {
            CommonName = "Kenya",
            ...
            Borders = new[]
            {
                CountryCodeISO3.ETH, CountryCodeISO3.SOM, CountryCodeISO3.SSD, CountryCodeISO3.TZA, CountryCodeISO3.UGA
            },
            Landlocked = false,
            Area = 580367
        };

        public static Country Kyrgyzstan => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Central Asia",
            Borders = new[] {CountryCodeISO3.CHN, CountryCodeISO3.KAZ, CountryCodeISO3.TJK, CountryCodeISO3.UZB},
            Landlocked = true,
            Area = 199951
        };
        ...
        public static Country Cambodia => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.LAO, CountryCodeISO3.THA, CountryCodeISO3.VNM},
            Landlocked = false,
            Area = 181035
        };

        public static Country Kiribati => new Country
        {
            CommonName = "Kiribati",
        ...
        public static Country SaintKittsandNevis => new Country
        {
        ...
        public static Country SouthKorea => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Eastern Asia",
            Borders = new[] {CountryCodeISO3.PRK},
            Landlocked = false,
            Area = 100210
        };

        public static Country Kosovo => new Country
        {
            CommonName = "Kosovo",
            ...
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[] {CountryCodeISO3.ALB, CountryCodeISO3.MKD, CountryCodeISO3.MNE, CountryCodeISO3.SRB},
            Landlocked = true,
            Area = 10908
        };

        public static Country Kuwait => new Country
        {
            CommonName = "Kuwait",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.IRQ, CountryCodeISO3.SAU},
            Landlocked = false,
            Area = 17818
        };
        ...
        public static Country Laos => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.MMR, CountryCodeISO3.KHM, CountryCodeISO3.CHN, CountryCodeISO3.THA, CountryCodeISO3.VNM
            },
            Landlocked = true,
            Area = 236800
        };

        public static Country Lebanon => new Country
        {
            CommonName = "Lebanon",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.ISR, CountryCodeISO3.SYR},
            Landlocked = false,
            Area = 10452
        };

        public static Country Liberia => new Country
        {
            CommonName = "Liberia",
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.GIN, CountryCodeISO3.CIV, CountryCodeISO3.SLE},
            Landlocked = false,
            Area = 111369
        };

        public static Country Libya => new Country
        {
            CommonName = "Libya",
            ...
            Borders = new[]
            {
                CountryCodeISO3.DZA, CountryCodeISO3.TCD, CountryCodeISO3.EGY, CountryCodeISO3.NER, CountryCodeISO3.SDN,
                CountryCodeISO3.TUN
            },
            Landlocked = false,
            Area = 1759540
        ...
        public static Country SaintLucia => new Country
        {
        ...
        public static Country Liechtenstein => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Western Europe",
            Borders = new[] {CountryCodeISO3.AUT, CountryCodeISO3.CHE},
            Landlocked = true,
            Area = 160
        };

        public static Country SriLanka => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Southern Asia",
            Borders = new[] {CountryCodeISO3.IND},
            Landlocked = false,
            Area = 65610
        };

        public static Country Lesotho => new Country
        {
            CommonName = "Lesotho",
            ...
            Region = "Africa",
            SubRegion = "Southern Africa",
            Borders = new[] {CountryCodeISO3.ZAF},
            Landlocked = true,
            Area = 30355
        };

        public static Country Lithuania => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.BLR, CountryCodeISO3.LVA, CountryCodeISO3.POL, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 65300
        };

        public static Country Luxembourg => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "LU", "Grand Duchy of Luxembourg", "Grand-Duché de Luxembourg", "Großherzogtum Luxemburg",
                "Groussherzogtum Lëtzebuerg"
            },
            Region = "Europe",
            SubRegion = "Western Europe",
            Borders = new[] {CountryCodeISO3.BEL, CountryCodeISO3.FRA, CountryCodeISO3.DEU},
            Landlocked = true,
            Area = 2586
        };

        public static Country Latvia => new Country
        {
            CommonName = "Latvia",
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.BLR, CountryCodeISO3.EST, CountryCodeISO3.LTU, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 64559
        };

        public static Country Macau => new Country
        {
            CommonName = "Macau",
            ...
            AlternativeSpellings = new[]
            {
                "MO", "澳门", "Macao", "Macao Special Administrative Region of the People's Republic of China",
        ...
        public static Country SaintMartin => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Caribbean",
            Borders = new[] {CountryCodeISO3.SXM},
            Landlocked = false,
            Area = 53
        };

        public static Country Morocco => new Country
        {
            CommonName = "Morocco",
            ...
            Region = "Africa",
            SubRegion = "Northern Africa",
            Borders = new[] {CountryCodeISO3.DZA, CountryCodeISO3.ESH, CountryCodeISO3.ESP},
            Landlocked = false,
            Area = 446550
        };

        public static Country Monaco => new Country
        {
            CommonName = "Monaco",
            ...
            Region = "Europe",
            SubRegion = "Western Europe",
            Borders = new[] {CountryCodeISO3.FRA},
            Landlocked = false,
            Area = 2
        };

        public static Country Moldova => new Country
        {
            CommonName = "Moldova",
            ...
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[] {CountryCodeISO3.ROU, CountryCodeISO3.UKR},
            Landlocked = true,
            Area = 33846
        };

        public static Country Madagascar => new Country
        {
        ...
        public static Country Maldives => new Country
        {
            CommonName = "Maldives",
        ...
        public static Country Mexico => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.BLZ, CountryCodeISO3.GTM, CountryCodeISO3.USA},
            Landlocked = false,
            Area = 1964375
        };

        public static Country MarshallIslands => new Country
        {
        ...
        public static Country Macedonia => new Country
        {
            ...
            Capital = "Skopje",
            AlternativeSpellings = new[]
                {"MK", "Macedonia, the Former Yugoslav Republic of", "Republic of Macedonia", "Република Македонија"},
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[]
            {
                CountryCodeISO3.ALB, CountryCodeISO3.BGR, CountryCodeISO3.GRC, CountryCodeISO3.KOS, CountryCodeISO3.SRB
            },
            Landlocked = true,
            Area = 25713
        };

        public static Country Mali => new Country
        {
            CommonName = "Mali",
            ...
            Borders = new[]
            {
                CountryCodeISO3.DZA, CountryCodeISO3.BFA, CountryCodeISO3.GIN, CountryCodeISO3.CIV, CountryCodeISO3.MRT,
                CountryCodeISO3.NER, CountryCodeISO3.SEN
            },
            Landlocked = true,
            Area = 1240192
        };

        public static Country Malta => new Country
        {
            CommonName = "Malta",
        ...
        public static Country Myanmar => new Country
        {
            CommonName = "Myanmar",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BGD, CountryCodeISO3.CHN, CountryCodeISO3.IND, CountryCodeISO3.LAO, CountryCodeISO3.THA
            },
            Landlocked = false,
            Area = 676578
        };

        public static Country Montenegro => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.ALB, CountryCodeISO3.BIH, CountryCodeISO3.HRV, CountryCodeISO3.KOS, CountryCodeISO3.SRB
            },
            Landlocked = false,
            Area = 13812
        };

        public static Country Mongolia => new Country
        {
            CommonName = "Mongolia",
            ...
            Region = "Asia",
            SubRegion = "Eastern Asia",
            Borders = new[] {CountryCodeISO3.CHN, CountryCodeISO3.RUS},
            Landlocked = true,
            Area = 1564110
        };

        public static Country NorthernMarianaIslands => new Country
        {
        ...
        public static Country Mozambique => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.MWI, CountryCodeISO3.ZAF, CountryCodeISO3.SWZ, CountryCodeISO3.TZA, CountryCodeISO3.ZMB,
                CountryCodeISO3.ZWE
            },
            Landlocked = false,
            Area = 801590
        ...
        public static Country Mauritania => new Country
        {
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.DZA, CountryCodeISO3.MLI, CountryCodeISO3.SEN, CountryCodeISO3.ESH},
            Landlocked = false,
            Area = 1030700
        };

        public static Country Montserrat => new Country
        {
        ...
        public static Country Martinique => new Country
        {
        ...
        public static Country Mauritius => new Country
        {
        ...
        public static Country Malawi => new Country
        {
            CommonName = "Malawi",
            ...
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.MOZ, CountryCodeISO3.TZA, CountryCodeISO3.ZMB},
            Landlocked = true,
            Area = 118484
        };
        ...
        public static Country Malaysia => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.BRN, CountryCodeISO3.IDN, CountryCodeISO3.THA},
            Landlocked = false,
            Area = 330803
        };

        public static Country Mayotte => new Country
        {
            CommonName = "Mayotte",
        ...
        public static Country Namibia => new Country
        {
            CommonName = "Namibia",
            ...
            Region = "Africa",
            SubRegion = "Southern Africa",
            Borders = new[] {CountryCodeISO3.AGO, CountryCodeISO3.BWA, CountryCodeISO3.ZAF, CountryCodeISO3.ZMB},
            Landlocked = false,
            Area = 825615
        };

        public static Country NewCaledonia => new Country
        {
        ...
        public static Country Niger => new Country
        {
            CommonName = "Niger",
            ...
            Borders = new[]
            {
                CountryCodeISO3.DZA, CountryCodeISO3.BEN, CountryCodeISO3.BFA, CountryCodeISO3.TCD, CountryCodeISO3.LBY,
                CountryCodeISO3.MLI, CountryCodeISO3.NGA
            },
            Landlocked = true,
            Area = 1267000
        };

        public static Country NorfolkIsland => new Country
        {
        ...
        public static Country Nigeria => new Country
        {
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.BEN, CountryCodeISO3.CMR, CountryCodeISO3.TCD, CountryCodeISO3.NER},
            Landlocked = false,
            Area = 923768
        };

        public static Country Nicaragua => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.CRI, CountryCodeISO3.HND},
            Landlocked = false,
            Area = 130373
        };

        public static Country Niue => new Country
        {
            CommonName = "Niue",
            OfficialName = "Niue",
            TLD = new[] {".nu"},
        ...
        public static Country Netherlands => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Western Europe",
            Borders = new[] {CountryCodeISO3.BEL, CountryCodeISO3.DEU},
            Landlocked = false,
            Area = 41850
        };

        public static Country Norway => new Country
        {
            CommonName = "Norway",
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.FIN, CountryCodeISO3.SWE, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 323802
        };

        public static Country Nepal => new Country
        {
            CommonName = "Nepal",
        ...
        public static Country Nauru => new Country
        {
            CommonName = "Nauru",
        ...
        public static Country NewZealand => new Country
        {
        ...
        public static Country Oman => new Country
        {
            CommonName = "Oman",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.SAU, CountryCodeISO3.ARE, CountryCodeISO3.YEM},
            Landlocked = false,
            Area = 309500
        };

        public static Country Pakistan => new Country
        {
            CommonName = "Pakistan",
            ...
            Region = "Asia",
            SubRegion = "Southern Asia",
            Borders = new[] {CountryCodeISO3.AFG, CountryCodeISO3.CHN, CountryCodeISO3.IND, CountryCodeISO3.IRN},
            Landlocked = false,
            Area = 881912
        };

        public static Country Panama => new Country
        {
            CommonName = "Panama",
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.COL, CountryCodeISO3.CRI},
            Landlocked = false,
            Area = 75417
        };

        public static Country PitcairnIslands => new Country
        {
        ...
        public static Country Peru => new Country
        {
            CommonName = "Peru",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BOL, CountryCodeISO3.BRA, CountryCodeISO3.CHL, CountryCodeISO3.COL, CountryCodeISO3.ECU
            },
            Landlocked = false,
            Area = 1285216
        };

        public static Country Philippines => new Country
        {
        ...
        public static Country Palau => new Country
        {
            CommonName = "Palau",
        ...
        public static Country PapuaNewGuinea => new Country
        {
            ...
            Region = "Oceania",
            SubRegion = "Melanesia",
            Borders = new[] {CountryCodeISO3.IDN},
            Landlocked = false,
            Area = 462840
        };
        ...
        public static Country Poland => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BLR, CountryCodeISO3.CZE, CountryCodeISO3.DEU, CountryCodeISO3.LTU, CountryCodeISO3.RUS,
                CountryCodeISO3.SVK, CountryCodeISO3.UKR
            },
            Landlocked = false,
            Area = 312679
        };

        public static Country PuertoRico => new Country
        {
        ...
        public static Country NorthKorea => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "KP", "Democratic People's Republic of Korea", "조선민주주의인민공화국", "Chosŏn Minjujuŭi Inmin Konghwaguk",
                "Korea, Democratic People's Republic of"
            },
            Region = "Asia",
            SubRegion = "Eastern Asia",
            Borders = new[] {CountryCodeISO3.CHN, CountryCodeISO3.KOR, CountryCodeISO3.RUS},
            Landlocked = false,
            Area = 120538
        };

        public static Country Portugal => new Country
        {
            CommonName = "Portugal",
        ...
        public static Country Paraguay => new Country
        {
            CommonName = "Paraguay",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.ARG, CountryCodeISO3.BOL, CountryCodeISO3.BRA},
            Landlocked = true,
            Area = 406752
        };

        public static Country Palestine => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.ISR, CountryCodeISO3.EGY, CountryCodeISO3.JOR},
            Landlocked = false,
            Area = 6220
        };

        public static Country FrenchPolynesia => new Country
        {
        ...
        public static Country Qatar => new Country
        {
            CommonName = "Qatar",
            ...
            Region = "Asia",
            SubRegion = "Western Asia",
            Borders = new[] {CountryCodeISO3.SAU},
            Landlocked = false,
            Area = 11586
        };

        public static Country Réunion => new Country
        {
            CommonName = "Réunion",
        ...
        public static Country Romania => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BGR, CountryCodeISO3.HUN, CountryCodeISO3.MDA, CountryCodeISO3.SRB, CountryCodeISO3.UKR
            },
            Landlocked = false,
            Area = 238391
        };

        public static Country Russia => new Country
        {
            CommonName = "Russia",
            ...
            Capital = "Moscow",
            AlternativeSpellings = new[]
                {"RU", "Rossiya", "Russian Federation", "Российская Федерация", "Rossiyskaya Federatsiya"},
            Region = "Europe",
            SubRegion = "Eastern Europe",
            Borders = new[]
            {
                CountryCodeISO3.AZE, CountryCodeISO3.BLR, CountryCodeISO3.CHN, CountryCodeISO3.EST, CountryCodeISO3.FIN,
                CountryCodeISO3.GEO, CountryCodeISO3.KAZ, CountryCodeISO3.PRK, CountryCodeISO3.LVA, CountryCodeISO3.LTU,
                CountryCodeISO3.MNG, CountryCodeISO3.NOR, CountryCodeISO3.POL, CountryCodeISO3.UKR
            },
            Landlocked = false,
            Area = 17098242
        };

        public static Country Rwanda => new Country
        {
            CommonName = "Rwanda",
            ...
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.BDI, CountryCodeISO3.COD, CountryCodeISO3.TZA, CountryCodeISO3.UGA},
            Landlocked = true,
            Area = 26338
        };

        public static Country SaudiArabia => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.IRQ, CountryCodeISO3.JOR, CountryCodeISO3.KWT, CountryCodeISO3.OMN, CountryCodeISO3.QAT,
                CountryCodeISO3.ARE, CountryCodeISO3.YEM
            },
            Landlocked = false,
            Area = 2149690
        };

        public static Country Sudan => new Country
        {
            CommonName = "Sudan",
            ...
            Borders = new[]
            {
                CountryCodeISO3.CAF, CountryCodeISO3.TCD, CountryCodeISO3.EGY, CountryCodeISO3.ERI, CountryCodeISO3.ETH,
                CountryCodeISO3.LBY, CountryCodeISO3.SSD
            },
            Landlocked = false,
            Area = 1886068
        };

        public static Country Senegal => new Country
        {
            CommonName = "Senegal",
            ...
            Borders = new[]
            {
                CountryCodeISO3.GMB, CountryCodeISO3.GIN, CountryCodeISO3.GNB, CountryCodeISO3.MLI, CountryCodeISO3.MRT
            },
            Landlocked = false,
            Area = 196722
        };

        public static Country Singapore => new Country
        {
        ...
        public static Country SouthGeorgia => new Country
        {
        ...
        public static Country SvalbardandJanMayen => new Country
        {
        ...
        public static Country SolomonIslands => new Country
        {
        ...
        public static Country SierraLeone => new Country
        {
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.GIN, CountryCodeISO3.LBR},
            Landlocked = false,
            Area = 71740
        };

        public static Country ElSalvador => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Central America",
            Borders = new[] {CountryCodeISO3.GTM, CountryCodeISO3.HND},
            Landlocked = false,
            Area = 21041
        };

        public static Country SanMarino => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.ITA},
            Landlocked = true,
            Area = 61
        };

        public static Country Somalia => new Country
        {
            CommonName = "Somalia",
            ...
            AlternativeSpellings = new[]
            {
                "SO", "aṣ-Ṣūmāl", "Federal Republic of Somalia", "Jamhuuriyadda Federaalka Soomaaliya",
                "Jumhūriyyat aṣ-Ṣūmāl al-Fiderāliyya"
            },
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.DJI, CountryCodeISO3.ETH, CountryCodeISO3.KEN},
            Landlocked = false,
            Area = 637657
        };

        public static Country SaintPierreandMiquelon => new Country
        {
        ...
        public static Country Serbia => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BIH, CountryCodeISO3.BGR, CountryCodeISO3.HRV, CountryCodeISO3.HUN, CountryCodeISO3.KOS,
                CountryCodeISO3.MKD, CountryCodeISO3.MNE, CountryCodeISO3.ROU
            },
            Landlocked = true,
            Area = 88361
        };

        public static Country SouthSudan => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.CAF, CountryCodeISO3.COD, CountryCodeISO3.ETH, CountryCodeISO3.KEN, CountryCodeISO3.SDN,
                CountryCodeISO3.UGA
            },
            Landlocked = true,
            Area = 619745
        ...
        public static Country SãoToméandPríncipe => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "ST", "Democratic Republic of São Tomé and Príncipe", "Sao Tome and Principe",
        ...
        public static Country Suriname => new Country
        {
            CommonName = "Suriname",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.BRA, CountryCodeISO3.GUF, CountryCodeISO3.GUY},
            Landlocked = false,
            Area = 163820
        };

        public static Country Slovakia => new Country
        {
            CommonName = "Slovakia",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AUT, CountryCodeISO3.CZE, CountryCodeISO3.HUN, CountryCodeISO3.POL, CountryCodeISO3.UKR
            },
            Landlocked = true,
            Area = 49037
        };

        public static Country Slovenia => new Country
        {
            CommonName = "Slovenia",
            ...
            Region = "Europe",
            SubRegion = "Southern Europe",
            Borders = new[] {CountryCodeISO3.AUT, CountryCodeISO3.HRV, CountryCodeISO3.ITA, CountryCodeISO3.HUN},
            Landlocked = false,
            Area = 20273
        };
        ...
        public static Country Sweden => new Country
        {
            ...
            Region = "Europe",
            SubRegion = "Northern Europe",
            Borders = new[] {CountryCodeISO3.FIN, CountryCodeISO3.NOR},
            Landlocked = false,
            Area = 450295
        };

        public static Country Swaziland => new Country
        {
            ...
            Capital = "Lobamba",
            AlternativeSpellings = new[]
                {"SZ", "weSwatini", "Swatini", "Ngwane", "Kingdom of Swaziland", "Umbuso waseSwatini"},
            Region = "Africa",
            SubRegion = "Southern Africa",
            Borders = new[] {CountryCodeISO3.MOZ, CountryCodeISO3.ZAF},
            Landlocked = true,
            Area = 17364
        };

        public static Country SintMaarten => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Caribbean",
            Borders = new[] {CountryCodeISO3.MAF},
            Landlocked = false,
            Area = 34
        };

        public static Country Seychelles => new Country
        {
            ...
            Capital = "Victoria",
            AlternativeSpellings =
                new[] {"SC", "Republic of Seychelles", "Repiblik Sesel", "République des Seychelles"},
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new CountryCodeISO3[] { },
            Landlocked = false,
        ...
        public static Country Syria => new Country
        {
            CommonName = "Syria",
            ...
            Borders = new[]
            {
                CountryCodeISO3.IRQ, CountryCodeISO3.ISR, CountryCodeISO3.JOR, CountryCodeISO3.LBN, CountryCodeISO3.TUR
            },
            Landlocked = false,
            Area = 185180
        };

        public static Country TurksandCaicosIslands => new Country
        {
        ...
        public static Country Chad => new Country
        {
            CommonName = "Chad",
            ...
            Borders = new[]
            {
                CountryCodeISO3.CMR, CountryCodeISO3.CAF, CountryCodeISO3.LBY, CountryCodeISO3.NER, CountryCodeISO3.NGA,
                CountryCodeISO3.SSD
            },
            Landlocked = true,
            Area = 1284000
        ...
        public static Country Togo => new Country
        {
            CommonName = "Togo",
            ...
            Region = "Africa",
            SubRegion = "Western Africa",
            Borders = new[] {CountryCodeISO3.BEN, CountryCodeISO3.BFA, CountryCodeISO3.GHA},
            Landlocked = false,
            Area = 56785
        };
        ...
        public static Country Thailand => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.MMR, CountryCodeISO3.KHM, CountryCodeISO3.LAO, CountryCodeISO3.MYS},
            Landlocked = false,
            Area = 513120
        };

        public static Country Tajikistan => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Central Asia",
            Borders = new[] {CountryCodeISO3.AFG, CountryCodeISO3.CHN, CountryCodeISO3.KGZ, CountryCodeISO3.UZB},
            Landlocked = true,
            Area = 143100
        };

        public static Country Tokelau => new Country
        {
            CommonName = "Tokelau",
        ...
        public static Country Turkmenistan => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "Central Asia",
            Borders = new[] {CountryCodeISO3.AFG, CountryCodeISO3.IRN, CountryCodeISO3.KAZ, CountryCodeISO3.UZB},
            Landlocked = true,
            Area = 488100
        };

        public static Country TimorLeste => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "TL", "East Timor", "Democratic Republic of Timor-Leste", "República Democrática de Timor-Leste",
                "Repúblika Demokrátika Timór-Leste", "Timór Lorosa'e", "Timor Lorosae"
            },
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.IDN},
        ...
        public static Country Tonga => new Country
        {
            CommonName = "Tonga",
        ...
        public static Country TrinidadandTobago => new Country
        {
        ...
        public static Country Tunisia => new Country
        {
            CommonName = "Tunisia",
            ...
            Region = "Africa",
            SubRegion = "Northern Africa",
            Borders = new[] {CountryCodeISO3.DZA, CountryCodeISO3.LBY},
            Landlocked = false,
            Area = 163610
        };

        public static Country Turkey => new Country
        {
            CommonName = "Turkey",
            ...
            Borders = new[]
            {
                CountryCodeISO3.ARM, CountryCodeISO3.AZE, CountryCodeISO3.BGR, CountryCodeISO3.GEO, CountryCodeISO3.GRC,
                CountryCodeISO3.IRN, CountryCodeISO3.IRQ, CountryCodeISO3.SYR
            },
            Landlocked = false,
            Area = 783562
        };

        public static Country Tuvalu => new Country
        {
            CommonName = "Tuvalu",
            OfficialName = "Tuvalu",
            TLD = new[] {".tv"},
        ...
        public static Country Taiwan => new Country
        {
            CommonName = "Taiwan",
            ...
            AlternativeSpellings = new[]
            {
                "TW", "Táiwān", "Republic of China", "中華民國", "Zhōnghuá Mínguó", "Chinese Taipei for IOC",
        ...
        public static Country Tanzania => new Country
        {
            CommonName = "Tanzania",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BDI, CountryCodeISO3.COD, CountryCodeISO3.KEN, CountryCodeISO3.MWI, CountryCodeISO3.MOZ,
                CountryCodeISO3.RWA, CountryCodeISO3.UGA, CountryCodeISO3.ZMB
            },
            Landlocked = false,
            Area = 945087
        };

        public static Country Uganda => new Country
        {
            CommonName = "Uganda",
            ...
            Borders = new[]
            {
                CountryCodeISO3.COD, CountryCodeISO3.KEN, CountryCodeISO3.RWA, CountryCodeISO3.SSD, CountryCodeISO3.TZA
            },
            Landlocked = true,
            Area = 241550
        };

        public static Country Ukraine => new Country
        {
            CommonName = "Ukraine",
            ...
            Borders = new[]
            {
                CountryCodeISO3.BLR, CountryCodeISO3.HUN, CountryCodeISO3.MDA, CountryCodeISO3.POL, CountryCodeISO3.ROU,
                CountryCodeISO3.RUS, CountryCodeISO3.SVK
            },
            Landlocked = false,
            Area = 603500
        };

        public static Country UnitedStatesMinorOutlyingIslands => new Country
        {
        ...
        public static Country Uruguay => new Country
        {
            CommonName = "Uruguay",
            ...
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.ARG, CountryCodeISO3.BRA},
            Landlocked = false,
            Area = 181034
        };
        ...
        public static Country UnitedStates => new Country
        {
            ...
            Region = "Americas",
            SubRegion = "Northern America",
            Borders = new[] {CountryCodeISO3.CAN, CountryCodeISO3.MEX},
            Landlocked = false,
            Area = 9372610
        };

        public static Country Uzbekistan => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.AFG, CountryCodeISO3.KAZ, CountryCodeISO3.KGZ, CountryCodeISO3.TJK, CountryCodeISO3.TKM
            },
            Landlocked = true,
            Area = 447400
        };

        public static Country VaticanCity => new Country
        {
        ...
        public static Country SaintVincentandtheGrenadines => new Country
        {
        ...
        public static Country Venezuela => new Country
        {
            ...
            AlternativeSpellings = new[]
            {
                "VE", "Bolivarian Republic of Venezuela", "Venezuela, Bolivarian Republic of",
                "República Bolivariana de Venezuela"
            },
            Region = "Americas",
            SubRegion = "South America",
            Borders = new[] {CountryCodeISO3.BRA, CountryCodeISO3.COL, CountryCodeISO3.GUY},
            Landlocked = false,
            Area = 916445
        };

        public static Country BritishVirginIslands => new Country
        {
        ...
        public static Country UnitedStatesVirginIslands => new Country
        {
        ...
        public static Country Vietnam => new Country
        {
            ...
            Region = "Asia",
            SubRegion = "South-Eastern Asia",
            Borders = new[] {CountryCodeISO3.KHM, CountryCodeISO3.CHN, CountryCodeISO3.LAO},
            Landlocked = false,
            Area = 331212
        };

        public static Country Vanuatu => new Country
        {
            CommonName = "Vanuatu",
        ...
        public static Country WallisandFutuna => new Country
        {
        ...
        public static Country Samoa => new Country
        {
            CommonName = "Samoa",
        ...
        public static Country Yemen => new Country
        {
            CommonName = "Yemen",
        ...
        public static Country SouthAfrica => new Country
        {
            ...
            Borders = new[]
            {
                CountryCodeISO3.BWA, CountryCodeISO3.LSO, CountryCodeISO3.MOZ, CountryCodeISO3.NAM, CountryCodeISO3.SWZ,
                CountryCodeISO3.ZWE
            },
            Landlocked = false,
            Area = 1221037
        ...
        public static Country Zambia => new Country
        {
            CommonName = "Zambia",
            ...
            Borders = new[]
            {
                CountryCodeISO3.AGO, CountryCodeISO3.BWA, CountryCodeISO3.COD, CountryCodeISO3.MWI, CountryCodeISO3.MOZ,
                CountryCodeISO3.NAM, CountryCodeISO3.TZA, CountryCodeISO3.ZWE
            },
            Landlocked = true,
            Area = 752612
        };

        public static Country Zimbabwe => new Country
        {
            CommonName = "Zimbabwe",
            ...
            Region = "Africa",
            SubRegion = "Eastern Africa",
            Borders = new[] {CountryCodeISO3.BWA, CountryCodeISO3.MOZ, CountryCodeISO3.ZAF, CountryCodeISO3.ZMB},
            Landlocked = true,
            Area = 390757
        };
