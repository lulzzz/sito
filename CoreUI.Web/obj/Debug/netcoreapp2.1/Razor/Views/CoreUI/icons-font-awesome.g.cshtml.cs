#pragma checksum "D:\PROGETTI\sito\AspNetCore2CoreUI-2.0\src\CoreUI.Web\Views\CoreUI\icons-font-awesome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "baa85fa10e6c0a6c9ce94637b80ee45665a7b9d0"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"baa85fa10e6c0a6c9ce94637b80ee45665a7b9d0", @"/Views/CoreUI/icons-font-awesome.cshtml")]
...
<div class=""animated fadeIn"">
    ...
    ");
            ...
            WriteLiteral(@"</div>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=");
            WriteLiteral(@"""fa fa-imdb fa-lg mt-4""></i>
                    <br>imdb
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"ol-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
       ");
            WriteLiteral(@"             <i class=""fa fa-telegram fa-lg mt-4""></i>
                    <br>telegram
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i");
            WriteLiteral(@" class=""fa fa-vcard-o fa-lg mt-4""></i>
                    <br>vcard-o
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
              ");
            WriteLiteral(@"      <i class=""fa fa-window-restore fa-lg mt-4""></i>
                    <br>window-restore
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""new"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-codiepie fa-lg mt-4"">");
            WriteLiteral(@"</i>
                    <br>codiepie
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"ass=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-redd");
            WriteLiteral(@"it-alien fa-lg mt-4""></i>
                    <br>reddit-alien
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
...
");
    ...
    <div class=""card"" id=""web-application"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"       <br>bar-chart
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-battery-1 fa-lg mt");
            WriteLiteral(@"-4""></i>
                    <br>battery-1
                    <span class=""text-muted"">(alias)</span>
                </div>
  ...
  ");
            WriteLiteral(@"                  <br>bug
                ...
                <div class=""col-6 col-sm-4 col-md-3 co");
            WriteLiteral(@"l-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ");
            WriteLiteral(@"                  <i class=""fa fa-calendar-o fa-lg mt-4""></i>
                    <br>calendar-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ...
     ");
            WriteLiteral(@"               <br>car
                ...
                ");
            WriteLiteral(@"    <br>cart-arrow-down
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            WriteLiteral(@"              </div>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ");
            WriteLiteral(@"               <i class=""fa fa-coffee fa-lg mt-4""></i>
                    <br>coffee
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
 ...
 ");
            WriteLiteral(@"               <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i c");
            WriteLiteral(@"lass=""fa fa-creative-commons fa-lg mt-4""></i>
                    <br>creative-commons
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            ...
            WriteLiteral(@"-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-fi");
            WriteLiteral(@"le-excel-o fa-lg mt-4""></i>
                    <br>file-excel-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
            ...
            WriteLiteral(@" <br>gift
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    ...
                    <br>hand-grab-o
                    <span c");
            WriteLiteral(@"lass=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"ss=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                  ");
            WriteLiteral(@"  <i class=""fa fa-info-circle fa-lg mt-4""></i>
                    <br>info-circle
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
       ...
       ");
        ...
        ");
            WriteLiteral(@"        </div>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
     ");
            WriteLiteral(@"               <i class=""fa fa-map fa-lg mt-4""></i>
                    <br>map
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
 ...
 ");
            WriteLiteral(@"               <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
      ");
            WriteLiteral(@"              <i class=""fa fa-minus-square-o fa-lg mt-4""></i>
                    <br>minus-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-mo");
            WriteLiteral(@"rtar-board fa-lg mt-4""></i>
                    <br>mortar-board
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
 ");
            WriteLiteral(@"                   <i class=""fa fa-newspaper-o fa-lg mt-4""></i>
                    <br>newspaper-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-paper-plane-o fa-lg mt-4"">");
            WriteLiteral(@"</i>
                    <br>paper-plane-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
         ");
            WriteLiteral(@"           <i class=""fa fa-question-circle fa-lg mt-4""></i>
                    <br>question-circle
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"       <br>reply-all
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
         ");
            WriteLiteral(@"           <i class=""fa fa-search fa-lg mt-4""></i>
                    <br>search
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            WriteLiteral(@"                  <br>share-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
...
");
    ...
    ");
            WriteLiteral(@"                <br>sort-amount-asc
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
       ...
       ");
            WriteLiteral(@"             <br>sort-numeric-asc
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
   ...
   ");
         ...
         ");
            ...
            WriteLiteral(@" fa-lg mt-4""></i>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <");
            WriteLiteral(@"i class=""fa fa-tree fa-lg mt-4""></i>
                    <br>tree
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
  ...
  ");
            ...
            WriteLiteral(@"<div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-video-camera fa-l");
    ...
    <div class=""card"" id=""hand"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
              ");
            WriteLiteral(@"      <i class=""fa fa-hand-stop-o fa-lg mt-4""></i>
                    <br>hand-stop-o
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""transportati");
            WriteLiteral(@"on"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i");
            WriteLiteral(@" class=""fa fa-cab fa-lg mt-4""></i>
                    <br>cab
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"     <br>rocket
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
          ");
            WriteLiteral(@"          <i class=""fa fa-truck fa-lg mt-4""></i>
                    <br>truck
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-wheelchair fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""gender"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                  ");
            WriteLiteral(@"  <i class=""fa fa-mars fa-lg mt-4""></i>
                    <br>mars
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""file-type"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-file");
            WriteLiteral(@"-code-o fa-lg mt-4""></i>
                    <br>file-code-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""spinner"">
        ...
        <div class=""card-body"">
            ...
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""");
            WriteLiteral(@"fa fa-gear fa-lg mt-4""></i>
                    <br>gear
                    <span class=""text-muted"">(alias)</span>
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""form-control"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa");
            WriteLiteral(@" fa-check-square-o fa-lg mt-4""></i>
                    <br>check-square-o
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-circle fa-lg mt-4""></i>
    ...
    <div class=""card"" id=""payment"">
        ...
        <div class=""card-body"">
            ...
            WriteLiteral(@"-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-cc-paypa");
            WriteLiteral(@"l fa-lg mt-4""></i>
                    <br>cc-paypal
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""currency"">
      ...
      ");
            ...
            WriteLiteral(@" fa-lg mt-4""></i>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-ruble fa-lg mt-4""></");
            WriteLiteral(@"i>
                    <br>ruble
                    <span class=""text-muted"">(alias)</span>
                </div>
    ...
    <div class=""card"" id=""text-editor"">
        <div class=""card-header"">Text E");
            WriteLiteral(@"ditor Icons</div>
        <div class=""card-body"">
            <div class=""row text-center"">
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
        ...
        ");
            ...
            WriteLiteral(@"
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
           ");
            WriteLiteral(@"         <i class=""fa fa-header fa-lg mt-4""></i>
                    <br>header
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-paste fa-lg mt-4"">");
            WriteLiteral(@"</i>
                    <br>paste
                    <span class=""text-muted"">(alias)</span>
                </div>
 ...
 ");
            WriteLiteral(@"               </div>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
");
            WriteLiteral(@"                    <i class=""fa fa-text-height fa-lg mt-4""></i>
                    <br>text-height
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""directional"">
        ...
        <div class=""card-body"">
            <div class=""row text-center"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    ...
                    <br");
            WriteLiteral(@">angle-double-left
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
       ...
       ");
            ...
            WriteLiteral(@"ol-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-hand-o-right fa-l");
            WriteLiteral(@"g mt-4""></i>
                    <br>hand-o-right
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    <div class=""card"" id=""video-player"">
        ...
        ");
            ...
            WriteLiteral(@"ol-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-yo");
            WriteLiteral(@"utube-play fa-lg mt-4""></i>
                    <br>youtube-play
                </div>
            </div>
        </div>
       ...
       ");
          ...
          ");
            WriteLiteral(@"          <br>digg
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
         ");
            WriteLiteral(@"           <i class=""fa fa-expeditedssl fa-lg mt-4""></i>
                    <br>expeditedssl
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
   ");
            WriteLiteral(@"                 <i class=""fa fa-firefox fa-lg mt-4""></i>
                    <br>firefox
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"m-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
   ");
            WriteLiteral(@"                 <i class=""fa fa-google fa-lg mt-4""></i>
                    <br>google
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
    ...
    ");
        ...
        ");
            ...
            WriteLiteral(@"col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i cl");
            WriteLiteral(@"ass=""fa fa-qq fa-lg mt-4""></i>
                    <br>qq
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"br>reddit-square
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
       ");
            WriteLiteral(@"             <i class=""fa fa-share-alt-square fa-lg mt-4""></i>
                    <br>share-alt-square
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            WriteLiteral(@"l-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa ");
            WriteLiteral(@"fa-trello fa-lg mt-4""></i>
                    <br>trello
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
         ...
         ");
            ...
            WriteLiteral(@"/div>
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i c");
            WriteLiteral(@"lass=""fa fa-y-combinator fa-lg mt-4""></i>
                    <br>y-combinator
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
            ...
            <div class=""alert alert-success mt-4"">
                <ul class=""margin-bottom-none padding-left-lg"">
                    ...
                    <li>The use of the");
            WriteLiteral(@"se trademarks does not indicate endorsement of the trademark holder by Font Awesome, nor vice versa.</li>
        ...
        <div class=""card-body"">
         ...
         ");
            WriteLiteral(@"       <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                ...
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
                    <i class=""fa fa-st");
            WriteLiteral(@"ethoscope fa-lg mt-4""></i>
                    <br>stethoscope
                </div>
                <div class=""col-6 col-sm-4 col-md-3 col-lg-2"">
